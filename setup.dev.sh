...
echo "from helios_auth.models import User; User.objects.create(user_type='google',user_id='${ADMIN_EMAIL_2}', info={'name':'${ADMIN_NAME_2}'}, admin_p=True)" | python manage.py shell
